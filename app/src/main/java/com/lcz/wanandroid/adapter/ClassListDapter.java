 ...
 */
public class ClassListDapter extends RecyclerView.Adapter {
    private ArrayList<ClassListBean.DataBean.DatasBean> mList;
    private Context context;

    public void setList(ArrayList<ClassListBean.DataBean.DatasBean> list) {
        mList = list;
    }

    public ClassListDapter(ArrayList<ClassListBean.DataBean.DatasBean> list, Context context) {
        mList = list;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        viewHolder.classify.setText(datasBean.getSuperChapterName()+"/"+datasBean.getChapterName());
    ...
    public Baseitemclick mBaseitemclick;
